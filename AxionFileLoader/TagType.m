...
classdef TagType
    ...
    methods (Static = true)
        function [value, success] = TryParse(aInput)
            ...
            known = [ ...
                TagType.Deleted, ...
                TagType.WellTreatment, ...
                TagType.UserAnnotation, ...
                TagType.SystemAnnotation, ...
                TagType.DataLossEvent, ...
                TagType.StimulationEvent, ...
                TagType.StimulationChannelGroup, ...
                TagType.StimulationWaveform, ...
                TagType.CalibrationTag, ...
                TagType.StimulationLedGroup, ...
                TagType.DoseEvent, ...
                TagType.StringDictonaryKeyPair, ...
                TagType.LeapInductionEvent, ...
                TagType.ViabilityImpedanceEvent ...
            ];
